...
func die() -> void:
	SignalHub.on_create_object_emit(global_position, Constants.ObjectType.EXPLOSION)
	SignalHub.on_create_object_emit(global_position, Constants.ObjectType.PICKUP)
	SignalHub.on_scored_points.emit(points)
